...
class PVRCNNROIHead(Base3DRoIHead):
    ...
    def _bbox_forward_train(self, seg_preds, keypoints_feats, keypoints,
        ...
        bbox_results = self._bbox_forward(seg_preds, keypoints_feats, keypoints,
                                          rois)
    ...
    def _bbox_forward(self, seg_preds, keypoints_feats, keypoints, rois):
        ...
        pooled_keypoints_feats = self.roi_extractor(keypoints_feats,
                                                    keypoints[..., 1:],
                                                    keypoints[..., 0].int(),
                                                    rois)
        cls_score, bbox_pred = self.bbox_head(pooled_keypoints_feats)
