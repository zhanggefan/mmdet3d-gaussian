...
def _draw_bboxes(bbox3d,
    ...
    for i in range(len(bbox3d)):
        ...
        vertices = geometry.PointCloud(box3d.get_box_points())
        line_set = geometry.LineSet.create_from_point_cloud_correspondences(
            vertices, vertices, [(0, 1), (1, 7), (7, 2), (2, 0),
                                 (3, 6), (6, 4), (4, 5), (5, 3),
                                 (0, 3), (1, 6), (7, 4), (2, 5),
                                 (1, 4), (6, 7)])
    ...
    line_sets.paint_uniform_color(bbox_color)
